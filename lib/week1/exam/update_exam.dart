...
class _UpdateExamState extends State<UpdateExam> {
  ...
  Container _buttonInContainer(BuildContext context) {
    return Container(
      margin: const EdgeInsets.fromLTRB(0, 0, 0, 10),
      child: Column(
        children: <Widget>[
          ElevatedButton(
            ...
            child: Text(saveText, style: const TextStyle(color: Colors.white)),
          )
        ],
      ),
    );
